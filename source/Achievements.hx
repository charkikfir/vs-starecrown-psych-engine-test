...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Stare",		"Beat Week stare on Hard with no Misses.",				'week1_nomiss',			false],
		["Too bad",				"Beat Week frog on Hard with no Misses.",				'week2_nomiss',			false],
		["Glitch",			"Beat Week jacobe on Hard with no Misses.",				'week3_nomiss',			false],
		["Its not a request",					"Beat Week randy on Hard with no Misses.",				'week4_nomiss',			false],
		["Cowboy",			"Beat Week cowbow on Hard with no Misses.",				'week5_nomiss',			false],
		["Fishbrain time!!!",					"Beat Week fishbrain on Hard with no Misses.",				'week6_nomiss',			false],
		["Triple trouble time!!!",		"Beat Week triple trouble on Hard with no Misses.",				'week7_nomiss',			 true],
